...
ICM45686::ICM45686(I2C_HandleTypeDef* I2C_Pin, UART_HandleTypeDef* Pin_Data):ICM45686_HAL(I2C_Pin){
...
uint8_t ICM45686::Connection(){
	...
	while(Product_ID != 0xE9){
		...
		if(Error >= 100){
			...
			HAL_UART_Transmit(&huart2, (uint8_t *)Error_Message.c_str(),Error_Message.length(),100);
